...
ax1 = plt.subplot(211)
ax1.plot(x_gamma, df_corr.values[:, 1], label="Max correlation", linewidth=4, color="blue")
ax1.plot(x_gamma, df_corr.values[:, 2], label="Mean correlation", linewidth=4, color="green")
